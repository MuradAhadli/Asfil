...
<header>
    ...
    <div class="container  logo-area h-100 sec_nav">
        ...
        <div class="row my-3 h-100 justify-content-center align-items-center">
            <div class="col-md-2 ">
                <a href="/">
                    <img src="{{asset('/img/logofooter.png')}}" class="img-fluid logo" alt="">
                    @if(session()->exists('brand'))
{{--                        <img src="{{asset('/img/logofooter.png')}}" class="img-fluid logo" alt="">--}}
                    @endif
                </a>
            </div>
            <div class="col-md-10" style="display: flex; align-items: center; justify-content: space-between;">
                ...
                <form action="" class="d-flex" style="width: 644px;">
    ...
    <div class="container nav-2 h-100 third_nav">
        ...
        <div class="row h-100 justify-content-center align-items-center">
            ...
            <div class="col-md-3 col-lg-3 d-flex active justify-content-center menu_div align-items-center">
                <img src="{{asset('/img/menu.png')}}" class="img-fluid menu-icon" alt="">
                <div class=" m-auto ">

                    <a style="color: #fff;" class="dropdown-toggle product_catalog" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        MƏHSUL KATALOQU
                    </a>
                    <div class="dropdown-menu w-100 drop_menu" style="height: 1000% !important;" aria-labelledby="navbarDropdown2">
...
<!--iNFO END-->
<!--SOCIAL START-->
<section class="social my-5" style="padding-top: 45px;padding-bottom: 45px; background-color: #0aa493;">
                        ...
                        $('#products').append(`
                            <div class="col-md-4 my-3 prdct p-2" id=${item['id']} data-price="">
                                ...
                                <div id="endirimler${item['id']}" class="endirimler">
                                    <h6 class="font-weight-bold esl_qiymet" style="color: #0aa493 !important; letter-spacing: 0;">
                                        ₼ ${item['qiymet']}
                                    </h6>
                                    <h6 class="font-weight-bold endirimli_qiymet" style="color: #0aa493 !important; letter-spacing: 0;">
                                        ₼ <span class="qymt" style="font-size: 16px;">${(item['qiymet'])*(100-item['endirim'])/100}</span>
                                    </h6>
                                </div>
                                <h6 style="color: #0aa493 !important; letter-spacing: 0;" id="price${item['id']}" class="font-weight-bold">₼ <span style="font-size: 16px;" class="qymt">${item['qiymet']}</span></h6>
