                                ...
                                @if($cat_product->status == 1)
                                    <div class="col-md-4 my-3 prdct  p-2" data-price="" id="{{$cat_product->id}}">
                                        ...
                                        <div class="bottom-product d-flex flex-column pt-3 justify-content-center">
                                            ...
                                            <div style="padding-left: 0;" data-rateyo-read-only="true" class="rating mb-1 rateYo1"  data-rateyo-rating="{{$cat_product->reytinq}}"></div>
                                            @if($cat_product->endirim > 0)
                                            ...
                                            @else
                                                <h6 class="font-weight-bold" style="color: #0aa493 !important; letter-spacing: 0;">
                ...
                @foreach($cookie_products as $cookie)
                    <div id="{{$cookie->id}}" class="col-md-3 my-2 product p-2">
                        ...
                        <div class="bottom-product d-flex flex-column pt-3 justify-content-center">
                            ...
                            <div style="padding-left: 0;" data-rateyo-read-only="true" class="rating mb-1 rateYo1"  data-rateyo-rating="{{$cookie->reytinq}}"></div>
                            @if($cookie->endirim > 0)
                                <div class="endirimler">
                                    <h6 class="font-weight-bold esl_qiymet" style="color: #0aa493 !important; letter-spacing: 0;">
                ...
                @foreach($cat_products as $cat)
                    <div id="{{$cat->id}}" class="col-md-3 my-2 product-new p-2">
                        ...
                        <div class="bottom-product d-flex flex-column pt-3 justify-content-center">
                            ...
                            <div style="padding-left: 0;" data-rateyo-read-only="true" class="rating mb-1 rateYo1"  data-rateyo-rating="{{$cat->reytinq}}"></div>
                            @if($cat->endirim > 0)
                                <div class="endirimler">
                                    <h6 class="font-weight-bold esl_qiymet" style="color: #0aa493 !important; letter-spacing: 0;">
        ...
        <div class="container">
            <div class="row iframe_links">
                <div class="col-md-4  my-1 pro_imgs_d  add_session" id="5">
                    <a class="iframe_link">
                        <img src="{{asset('img/group-4@2x.png')}}"  class="img-fluid pro_imgs" alt="">
                    </a>
                </div>
                <div class="col-md-4 my-1 pro_imgs_d  add_session" id="2">
                    <a class="iframe_link">
                        <img src="{{asset('img/group-3@2x.png')}}" class="img-fluid pro_imgs" alt="">
                    </a>
                </div>
                <div class="col-md-4 my-1 pro_imgs_d add_session" id="3">
                    <a class="iframe_link">
                        <img src="{{asset('img/group@2x.png')}}" class="img-fluid pro_imgs" alt="">
                    </a>
                </div>
            </div>
        </div>
